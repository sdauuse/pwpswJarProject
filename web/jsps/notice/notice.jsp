    ...
    <div id="notice">
        <table>
            ...
            <tr>
                ...
                <tr>
                    <div id="notice_index">
                        <td class="td2">上一篇:<a href="${pageContext.request.contextPath}/notice/noticeMain.action?ntsId=${notice.ntsId-1}" class="a1">上一条通告</a><br><br/>

                        下一篇:<a href="${pageContext.request.contextPath}/notice/noticeMain.action?ntsId=${notice.ntsId+1}" class="a1">下一条通告</a><br><br/>
